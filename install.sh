...
if rpm -qa | grep -q issabel 2>&1 > /dev/null;; then
  do wget -O - https://github.com/jacr6/bin/raw/master/issabel4-netinstall.sh | bash
fi&&

#10. Situarse en /var/www/html/
cd /var/www/html/&&
#20. clonar xone-connect en xone/
git clone https://jacr70@bitbucket.org/tradesystem/xone-connect.git xone&&
...
#50. crear en /var/www/html/xone/protected runtime 777
 mkdir  /var/www/html/xone/protected/runtime&& chmod -R 777 /var/www/html/xone/protected/runtime&&
